...
async def start_health_server():
    """Bind a dummy HTTP port so Render's port scan stops complaining.
    Render (as a Web Service) expects something listening on $PORT;
    this bot doesn't need HTTP, so this just answers 200 OK to any request."""
